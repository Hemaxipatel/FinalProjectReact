...
export default function LoginCom() {
    ...
    const loginHandler = () => {
        axios.post(`${BE_URL}user/signin`, user).then((resData) => {
                ...
                <div className="login-p">
                    <div className="row">
                        <Form>
                            ...
                            <Button onClick={() => loginHandler()} style={{ height: '55px', width: '480px', backgroundColor: '#FF3F6C', fontWeight: 'bold', border: 'none', borderRadius: 0, backgroundColor: '#5FB255' }}>
                                Signin
                            </Button>
                            <div>
